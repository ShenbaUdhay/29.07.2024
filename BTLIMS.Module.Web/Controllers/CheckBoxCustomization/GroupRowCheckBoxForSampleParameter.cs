...
namespace LDM.Module.Web.Controllers.CheckBoxCustomization
{
    ...
    public partial class GroupRowCheckBoxForSampleParameter : ViewController<ListView>
    {
        #region Declaration
        public const string keyFieldName = "Oid";
        private System.ComponentModel.IContainer components;
        public const string gridId = "SampleParameter_ListView_Copy_SampleRegistration";
        MessageTimer timer = new MessageTimer();
        #endregion

        #region Constructor
        public GroupRowCheckBoxForSampleParameter()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            TargetViewId = "SampleParameter_ListView_Copy_SampleRegistration;";
