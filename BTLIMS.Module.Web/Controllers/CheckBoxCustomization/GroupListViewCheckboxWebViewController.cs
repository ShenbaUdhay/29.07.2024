...
{
    public partial class GroupListViewCheckboxWebViewController : ViewController<ListView>
    {
        #region Declaration
        public const string keyFieldName = "Oid";
        public const string gridId = "SampleParameter_ListView_Copy_ResultValidation";
        MessageTimer timer = new MessageTimer();
        #endregion

        #region Constructor
        public GroupListViewCheckboxWebViewController()
        {
            InitializeComponent();
            TargetViewId =/* "SampleParameter_ListView_Copy_ResultValidation;" + "SampleParameter_ListView_Copy_ResultApproval;" +*/"SampleLogIn_Testparameters_ListView;";
        ...
        protected void Grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            try
            {
                ...
                if (groupedCols[groupedCols.Count - 1].FieldName == fieldname)
                {
                    ...
                    {
                        var key = (Grid.GetChildRow(index, childIndex) as SampleParameter).Oid;
                ...
                else
                {
                    ...
                    SampleParameter checkedDataRow = Grid.GetRow(index) as SampleParameter;
                    ...
                    {
                        SampleParameter row = Grid.GetRow(i) as SampleParameter;
        ...
        protected bool GetChecked(int visibleIndex)
        {
            try
            {
                ...
                {
                    var key = (Grid.GetChildRow(visibleIndex, childIndex) as SampleParameter).Oid;
