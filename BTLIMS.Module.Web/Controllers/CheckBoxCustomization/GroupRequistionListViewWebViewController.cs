...
namespace LDM.Module.Web.Controllers.CheckBoxCustomization
{
    ...
    public partial class GroupRequistionListViewWebViewController : ViewController
    {
        #region Declaration
        public const string keyFieldName = "Oid";
        public const string gridId = "Requisition_ListView_Approve";
        MessageTimer timer = new MessageTimer();
        #endregion
        public GroupRequistionListViewWebViewController()
        {
            InitializeComponent();
            TargetViewId = "Requisition_ListView_Approve;";
        ...
        protected void Grid_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            try
            {
                ...
                if (groupedCols[groupedCols.Count - 1].FieldName == fieldname)
                {
                    ...
                    {
                        var key = (Grid.GetChildRow(index, childIndex) as Requisition).Oid;
                ...
                else
                {
                    ...
                    Requisition checkedDataRow = Grid.GetRow(index) as Requisition;
                    ...
                    {
                        Requisition row = Grid.GetRow(i) as Requisition;
        ...
        protected bool GetChecked(int visibleIndex)
        {
            try
            {
                ...
                {
                    var key = (Grid.GetChildRow(visibleIndex, childIndex) as Requisition).Oid;
...
public class CheckboxReqGroupRowContentTemplate : ITemplate
{
    string gridId = "";

    #region Events
    public CheckboxReqGroupRowContentTemplate(string gridId)
    {
        this.gridId = gridId;
    }
