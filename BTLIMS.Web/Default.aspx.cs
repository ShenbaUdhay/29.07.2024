...
public partial class Default : BaseXafPage
{
    ...
    {
        base.OnLoad(e);
        string nameParameter = Request.Params["ClientName"];
    }
    ...
    protected void Page_Init()
    {
        try
        {
            ...
            CustomizeTemplateContent += (s, e) =>
            {
                ...
                {
                    //content.HeaderImageControl.ImageName = "LabMasterLogoWhite.png";
                    content.HeaderImageControl.ImageName = "NewAlpacaLogoWhite.png";
                }
                else
                {
                    //content.HeaderImageControl.ImageName = "LabMasterLogoBlack.png";
                    content.HeaderImageControl.ImageName = "NewAlpacaLogoBlack.png";
                }
            };
            ...
            if ((b.IsMatch(u) || v.IsMatch(u.Substring(0, 4))))
            {
                CustomizeTemplateContent += delegate (object sender, CustomizeTemplateContentEventArgs ev)
                {
                    IHeaderImageControlContainer content = TemplateContent as IHeaderImageControlContainer;
                    if (content == null) return;
                    content.HeaderImageControl.Visible = false;
                };
            }
        }
        catch (Exception ex)
