...
{
    public enum Friability { Dummy, Yes, No, [XafDisplayName("N/A")] NA }
    [DefaultClassOptions]
    public class PLMStereoscopicObservation : BaseObject
    {
        public PLMStereoscopicObservation(Session session) : base(session) { }
        ...
        #endregion
        #region QcbatchSequence
        private QCBatchSequence _Qcbatchsequence;
        public QCBatchSequence Qcbatchsequence
        {
            get { return _Qcbatchsequence; }
            set { SetPropertyValue(nameof(Qcbatchsequence), ref _Qcbatchsequence, value); }
        }
        #endregion
    }
}