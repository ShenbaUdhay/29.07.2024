...
{
    [DefaultClassOptions]
    public class PLMExam : BaseObject
    {
        public PLMExam(Session session) : base(session) { }
        public override void AfterConstruction()
        {
            base.AfterConstruction();
        }
        #region FiberType
        private FiberTypes _FiberType;
        public FiberTypes FiberType
        {
        ...
        #endregion
        #region PLMStereoscopicObservation
        private Guid _PLMStereoscopicObservation;
        public Guid PLMStereoscopicObservation
        {
            get { return _PLMStereoscopicObservation; }
            set { SetPropertyValue(nameof(PLMStereoscopicObservation), ref _PLMStereoscopicObservation, value); }
        }
        #endregion
        #region sort
        private int _Sort;
