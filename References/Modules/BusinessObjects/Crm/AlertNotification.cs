...
namespace XCRM.Module.BusinessObjects
{
    [DefaultClassOptions]
    public class AlertNotification : BaseObject, ISupportNotifications
    {
        // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public AlertNotification(Session session)
            : base(session)
        {
        }
        public override void AfterConstruction()
        {
            ...
            // User = Session.GetObjectByKey<DCUser>(SecuritySystem.CurrentUserId);
        ...
        public Employee User
        {
            ...
            set
            {
                SetPropertyValue<Employee>("User", ref _User, value);
            }
        }
        ...
        public NotificationCategory Category
        {
            ...
            set
            {
                SetPropertyValue<NotificationCategory>("Category", ref _Category, value);
            }
        }

        //private NotificationItemState _State;
        ...
        //    set
        //    {
        //        SetPropertyValue<NotificationItemState>(nameof(State),ref _State,value);
        //    }
        //}
        ...
        public bool IsDismissed
        {
            ...
            set { SetPropertyValue<bool>(nameof(IsDismissed), ref _IsDismissed, value); }
        }
