...
{
    [DefaultClassOptions]
    public class SampleMatrixSetupFields : BaseObject
    {
        public SampleMatrixSetupFields(Session session)
            : base(session)
        {
        }
        ...
        #region Width
        private int _Width;
        [RuleValueComparison("valSampleMatrixSetupWidth", DefaultContexts.Save, ValueComparisonType.GreaterThan, -1)]
        public int Width
        {
            get
            {
        ...
        [RuleValueComparison("valSampleMatrixSetupSort", DefaultContexts.Save, ValueComparisonType.GreaterThan, -1)]
