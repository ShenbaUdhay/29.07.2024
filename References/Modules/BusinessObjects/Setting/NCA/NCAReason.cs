...
namespace Modules.BusinessObjects.Setting.NCAID
{
    ...
    public class NCAReason : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public NCAReason(Session session)
            : base(session)
        {
        }
        ...
        [RuleRequiredField("MaintenancNCAReason", DefaultContexts.Save, "'Reason' must not be empty.")]
        public string Reason
        {
            get { return _Reason; }
            set { SetPropertyValue(nameof(Reason), ref _Reason, value.Trim()); }
        }
        ...
        public string Discription
        {
            ...
            set { SetPropertyValue(nameof(Discription), ref _Discription, value); }
        }
