...
namespace Modules.BusinessObjects.Setting
{
    ...
    public class TabFieldConfiguration : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public TabFieldConfiguration(Session session)
            : base(session)
        {
        }
        ...
        #region Width
        private int _Width;
        [RuleValueComparison("valTestFieldSetupWidth", DefaultContexts.Save, ValueComparisonType.GreaterThan, -1)]
        public int Width
        {
            get
            {
        ...
        [RuleValueComparison("valTestFieldSetupSort", DefaultContexts.Save, ValueComparisonType.GreaterThan, -1)]
