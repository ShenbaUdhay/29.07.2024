...
namespace Modules.BusinessObjects.Setting
{
    ...
    public class TabControls : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public TabControls(Session session)
            : base(session)
        {
        }
        ...
        [RuleRequiredField("Tab", DefaultContexts.Save, "Tab Control  must not be empty")]
        [RuleUniqueValue]
        public string TabName
        {
            ...
            set
            {
                SetPropertyValue(nameof(TabName), ref _TabName, value.Trim());
            }
        }
        #endregion
        ...
        #region CreatedBy
        private CustomSystemUser fCreatedBy;
        [VisibleInDetailView(false)]
        [VisibleInListView(false)]
        [VisibleInLookupListView(false)]
        public CustomSystemUser CreatedBy
        {
            ...
            set
            {
                SetPropertyValue("CreatedBy", ref fCreatedBy, value);
            }
        }
        #endregion
        ...
        public DateTime CreatedDate
        {
            ...
            set
            {
                SetPropertyValue("CreatedDate", ref fCreatedDate, value);
            }
        }
        #endregion
