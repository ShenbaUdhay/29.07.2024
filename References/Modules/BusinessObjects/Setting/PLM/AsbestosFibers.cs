...
{
    [DefaultClassOptions]
    public class AsbestosFibers : BaseObject
    {
        public AsbestosFibers(Session session) : base(session) { }
        ...
        #region AsbestosFibersName
        private string _AsbestosFibersName;
        [RuleRequiredField]
        public string AsbestosFibersName
        {
            get { return _AsbestosFibersName; }
            set { SetPropertyValue(nameof(AsbestosFibersName), ref _AsbestosFibersName, value); }
        }
        #endregion
