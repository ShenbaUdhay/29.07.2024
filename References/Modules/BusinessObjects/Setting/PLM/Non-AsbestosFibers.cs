...
{
    [DefaultClassOptions]
    public class Non_AsbestosFibers : BaseObject
    {
        public Non_AsbestosFibers(Session session) : base(session) { }
        ...
        #region NonAsbestosFiberName
        private string _NonAsbestosFiberName;
        [RuleRequiredField]
        public string NonAsbestosFiberName
        {
            get { return _NonAsbestosFiberName; }
            set { SetPropertyValue(nameof(NonAsbestosFiberName), ref _NonAsbestosFiberName, value); }
        }
        #endregion
