...
namespace Modules.BusinessObjects.Setting
{
    ...
    public class ResultRange : BaseObject
    {
        public ResultRange(Session session) : base(session) { }
        ...
        public string ResultOne
        {
            ...
            set { SetPropertyValue(nameof(ResultOne), ref _ResultOne, value); }
        }
        #endregion
        ...
        public string ResultTwo
        {
            ...
            set { SetPropertyValue(nameof(ResultTwo), ref _ResultTwo, value); }
        }
        #endregion
        ...
        public string DeleteDate
        {
            ...
            set { SetPropertyValue(nameof(DeleteDate), ref _DeleteDate, value); }
        }
        #endregion
