...
{
    [DefaultClassOptions]
    public class OtherComponents : BaseObject
    {
        public OtherComponents(Session session) : base(session) { }
        ...
        #region OtherComponentName
        private string _OtherComponentName;
        [RuleRequiredField]

        public string OtherComponentName
        {
            get { return _OtherComponentName; }
            set { SetPropertyValue(nameof(OtherComponentName), ref _OtherComponentName, value); }
        }
        #endregion
