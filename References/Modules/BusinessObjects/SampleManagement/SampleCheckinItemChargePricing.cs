...
namespace Modules.BusinessObjects.SampleManagement
{
    ...
    public class SampleCheckinItemChargePricing : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public SampleCheckinItemChargePricing(Session session)
            : base(session)
        {
        }
        ...
        [Association("SampleCheckin-SCItemChargePrice")]
        [VisibleInDetailView(false)]
        [VisibleInLookupListView(false)]
        [VisibleInListView(false)]
