...
namespace Modules.BusinessObjects.SampleManagement
{
    ...
    [DefaultClassOptions]
    //[Appearance("SampleLogIn", AppearanceItemType = "ViewItem", TargetItems = "*",
    //Criteria = "JobID==Null OR JobID==N/A ", Enabled = false, Context = "SampleLogIn_DetailView")]
    [RuleCriteria("RuleTimeNotequalToEndTime", DefaultContexts.Save, "TimeStart <> TimeEnd", CustomMessageTemplate = "TimeStart is not equal to TimeEnd.")]

    public class SampleLogIn : BaseObject, ICheckedListBoxItemsProvider
    {
        SampleLogInInfo sLInfo = new SampleLogInInfo();
        public SampleLogIn(Session session) : base(session)
        {
        }
        ...
        protected override void OnSaving()
        {
            ...
            base.OnSaving();
            LastUpdatedBy = Session.GetObjectByKey<Employee>(SecuritySystem.CurrentUserId).ToString();
            LastUpdatedDate = Library.GetServerTime(Session).ToString();
        ...
        //    {
        //        Exception ex = new Exception("Cannot Be Delete the Sample.! It is Attached to Test");
        //        throw ex;
        //    }
        //}
        #region ReceivedDate
        ...
        public DateTime? ReceivedDate
        {
            get
            {
                if (JobID != null && !JobID.IsSampling && JobID.RecievedDate != null && JobID.RecievedDate != DateTime.MinValue)
                {
                    _ReceivedDate = JobID.RecievedDate;
                }
                return _ReceivedDate;
            }
            set
            {
                SetPropertyValue(nameof(ReceivedDate), ref _ReceivedDate, value);
            }
        }
        #endregion
        ...
        [ImmediatePostData]
        [Appearance("JobID2", Enabled = true, Context = "DetailView")]
            ...
            get
            {
                if (SampleNo > 0)
                {
                    if (sLInfo.SampleIDDigit == SampleIDDigit.Three)
                    {
                        ...
                        {
                            return string.Format("{0}{1}{2}", JobID, "-00", SampleNo.ToString());
                        }
                        else if (SampleNo.ToString().Length == 2)
                        {
                            return string.Format("{0}{1}{2}", JobID, "-0", SampleNo.ToString());
                        }
                        else
                        {
                            return string.Format("{0}{1}{2}", JobID, "-", SampleNo.ToString());
                        }
                    }
                    else
                    {
        ...
        [Appearance("ClientSampleID", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        //[Appearance("VisualMatrix2", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ////[Appearance("CanEditVisualMatrix", Enabled = false, Criteria = "[CanChangeVisualMatrix] = 'CannotChange'", Context = "ListView")]
        ////[RuleRequiredField("VisualMatrix3", DefaultContexts.Save)]
        //[ImmediatePostData]
        ...
        public XPCollection<VisualMatrix> VisualMatrixs
        {
            get
            {
                if (JobID != null && !string.IsNullOrEmpty(JobID.SampleMatries))
                {
                    List<Guid> ids = JobID.SampleMatries.Split(';').Select(i => new Guid(i)).ToList();
        ...
        [Appearance("SampleType2", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        //[RuleRange(3, uint.MaxValue, CustomMessageTemplate = "Qty must be greater than 0")]
        public uint Qty
        {
            get { return _Qty; }
        ...
        [Appearance("Storage", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        [Appearance("Preservetives", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        [Appearance("SamplingLocation", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        [Appearance("QCType2", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        [Appearance("Collector2", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        public XPCollection<Collector> CollectorDataSource
        {
            get
            {
                if (JobID != null && JobID.ClientName != null)
                {
                    XPCollection<Collector> names = new XPCollection<Collector>(Session, CriteriaOperator.Parse("[CustomerName] Is Null or [CustomerName.Oid] = ?", JobID.ClientName.Oid));
        ...
        [Appearance("CollectDate2", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        ...
        [Appearance("FlowRate", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        [Size(int.MaxValue)]
        ...
        [Appearance("Length", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        ...
        [Appearance("Width", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        public string Width
        {
            get { return _Width; }
        ...
        [Appearance("TimeStart", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        ...
        [Appearance("TimeEnd", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        ...
        [Appearance("StartFlow(lpm)", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        [ImmediatePostData]
        ...
        [Appearance("EndFlow(lpm)", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        [ImmediatePostData]
        ...
        [Appearance("Volume", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        //[Size(int.MaxValue)]
        ...
        [ManyToManyAlias("SampleParameter", "Testparameter")]
        ...
        [NonPersistent]
        [ImmediatePostData]
        [Appearance("SLProjectID", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        [ReadOnly(false)]
        ...
        [Appearance("Time", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        //[ImmediatePostData]
        [Size(int.MaxValue)]
        public string Time
        {
        ...
        public DateTime DueDate
        {
            get
            {
                if (JobID != null && JobID.DueDate != null)
                {
                    _DueDate = (DateTime)JobID.DueDate;
                }
                return _DueDate;
            }
            set
        ...
        #endregion
        #region AssignToSampleAllocation
        [VisibleInDetailView(false)]
        [VisibleInListView(false)]
        private Employee _AssignToSampleAllocation;
        public Employee AssignToSampleAllocation
        {
            get { return _AssignToSampleAllocation; }
            set { SetPropertyValue<Employee>(nameof(AssignToSampleAllocation), ref _AssignToSampleAllocation, value); }
        }
        #endregion
        #region AssignTo
        [VisibleInDetailView(false)]
        ...
        public string BatchID
        {
            get
            {
                if (JobID != null && JobID.BatchID != null)
                {
                    _BatchID = JobID.BatchID;
                }
                return _BatchID;
            }
        ...
        public string PackageNumber
        {
            get
            {
                if (JobID != null && JobID.PackageNo != null)
                {
                    _PackageNumber = JobID.PackageNo;
                }
        ...
        public Labware BalanceID
        {
            get
            {
                if (JobID != null && JobID.BalanceID != null)
                {
                    _BalanceID = JobID.BalanceID;
                }
                return _BalanceID;
            }
        ...
        [ImmediatePostData]
        [ModelDefault("LookupProperty", "Samplestatus")]
        //[XafDisplayName("SampleStatus")]
        ...
        #region QCCategory
        private QCCategory _QCCategory;
        [ImmediatePostData(true)]
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false), VisibleInDashboards(false)]
        //[Appearance("QCCategory", Enabled = false, Criteria = "JobID IS NULL", Context = "DetailView")]
        public QCCategory QCCategory
        {
            get { return _QCCategory; }
            set { SetPropertyValue<QCCategory>("QCCategory", ref _QCCategory, value); }
        }
        #endregion

        #region SamplingStatus
        private SamplingStatus _SamplingStatus;
        [DefaultValue(0)]
        public SamplingStatus SamplingStatus
        {
            get
            {
                return _SamplingStatus;
            }
            set { SetPropertyValue(nameof(SamplingStatus), ref _SamplingStatus, value); }
        }
        #endregion
        ...
        #region stationcommment
        private string _stationcommment;
        public string stationcommment
        {
            get { return _stationcommment; }
            set { SetPropertyValue(nameof(stationcommment), ref _stationcommment, value); }
        }
        #endregion

        #region samplecomment
        private string _samplecomment;
        public string samplecomment
        {
            get { return _samplecomment; }
            set { SetPropertyValue(nameof(samplecomment), ref _samplecomment, value); }
        }
        #endregion
        ...
        public bool Personal
        {
            ...
            set
            {
                SetPropertyValue(nameof(Personal), ref _Personal, value);
            }
        }
        ...
        private string _Prevolume;
        public string Prevolume
        {
            get
            { return _Prevolume; }
            set
            {
                SetPropertyValue(nameof(Prevolume), ref _Prevolume, value);
            }
        }
        #endregion

        #region AbsorptionVol
        private string _Absorptionvol;
        public string Absorptionvol
        {
            get
            { return _Absorptionvol; }
            set
            {
                SetPropertyValue(nameof(Absorptionvol), ref _Absorptionvol, value);
            }
        }
        #endregion
        ...
        public TimeSpan? RestTime
        {
            ...
            set
            {
                SetPropertyValue(nameof(RestTime), ref _RestTime, value);
            }
        }
        #endregion
        ...
        #endregion
        #region TrafficFlowBigVechile
        private string _TrafficFlowBigVechile;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false)]
        public string TrafficFlowBigVechile
        {
            get { return _TrafficFlowBigVechile; }
            set { SetPropertyValue("TrafficFlowBigVechile", ref _TrafficFlowBigVechile, value); }
        }
        #endregion
        #region TrafficFlowMiddleVechile
        private string _TrafficFlowMiddleVechile;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false)]
        public string TrafficFlowMiddleVechile
        {
            get { return _TrafficFlowMiddleVechile; }
            set { SetPropertyValue("TrafficFlowMiddleVechile", ref _TrafficFlowMiddleVechile, value); }
        }
        #endregion
        #region TrafficFlowSmallVechile
        private string _TrafficFlowSmallVechile;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false)]
        public string TrafficFlowSmallVechile
        {
            get { return _TrafficFlowSmallVechile; }
            set { SetPropertyValue("TrafficFlowSmallVechile", ref _TrafficFlowSmallVechile, value); }
        }
        #endregion
        ...
        {
            get { return _Segment; }
            set { SetPropertyValue("Segment", ref _Segment, value); }
        }
        #endregion
        ...
        {
            get { return _Reach; }
            set { SetPropertyValue("Reach", ref _Reach, value); }
        }
        #endregion
        ...
        {
            get { return _Basin; }
            set { SetPropertyValue("Basin", ref _Basin, value); }
        }
        #endregion

        #region HAUNo
        private string _HAUNo;
        public string HAUNo
        {
            get { return _HAUNo; }
            set { SetPropertyValue("HAUNo", ref _HAUNo, value); }
        }
        #endregion
        ...
        {
            get { return _County; }
            set { SetPropertyValue("County", ref _County, value); }
        }
        #endregion
        ...
        public DateTime? RecordedDate
        {
            ...
            set { SetPropertyValue<DateTime?>("RecordedDate", ref _RecordedDate, value); }
        }
        #endregion

        #region RecordedBy
        private Employee _RecordedBy;
        public Employee RecordedBy
        {
            get { return _RecordedBy; }
            set { SetPropertyValue<Employee>("RecordedBy", ref _RecordedBy, value); }
        }
        #endregion        
        ...
        public string StationStatus
        {
            ...
            set { SetPropertyValue("StationStatus", ref _StationStatus, value); }
        }
        #endregion

        #region StatusReason
        private bool _StatusReason;
        [NonPersistent]
        public bool StatusReason
        {
            get { return _StatusReason; }
            set { SetPropertyValue("StatusReason", ref _StatusReason, value); }
        }
        #endregion
        ...
        public string MonitoringType
        {
            ...
            set { SetPropertyValue("MonitoringType", ref _MonitoringType, value); }
        }
        #endregion
        ...
        {
            get { return _QAO; }
            set { SetPropertyValue("QAO", ref _QAO, value); }
        }
        #endregion

        #region SampleCollectionDepth
        private string _SampleCollectionDepth;
        public string SampleCollectionDepth
        {
            get { return _SampleCollectionDepth; }
            set { SetPropertyValue("SampleCollectionDepth", ref _SampleCollectionDepth, value); }
        }
        #endregion
        ...
        #region JoinMonitoredBy
        private string _JoinMonitoredBy;
        public string JoinMonitoredBy
        {
            get { return _JoinMonitoredBy; }
            set { SetPropertyValue("JoinMonitoredBy", ref _JoinMonitoredBy, value); }
        }
        #endregion

        #region Sanitarian/Temp/DateTime
        private SanitarianTemperature _SanitarianTemp;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false), VisibleInDashboards(false)]
        public SanitarianTemperature SanitarianTemp
        {
            get { return _SanitarianTemp; }
            set { SetPropertyValue("SanitarianTemp", ref _SanitarianTemp, value); }
        }
        private string _Sanitarian;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false), VisibleInDashboards(false)]
        public string Sanitarian
        {
            get { return _Sanitarian; }
            set { SetPropertyValue("Sanitarian", ref _Sanitarian, value); }
        }
        private DateTime? _SanitarianDateTime;
        [VisibleInDetailView(false), VisibleInListView(false), VisibleInLookupListView(false), VisibleInDashboards(false)]
        public DateTime? SanitarianDateTime
        {
            get { return _SanitarianDateTime; }
            set { SetPropertyValue(nameof(SanitarianDateTime), ref _SanitarianDateTime, value); }
        }
        #endregion
        ...
        #region Kind
        private SLKind _Kind;
        public SLKind Kind
        {
            get { return _Kind; }
            set { SetPropertyValue("Kind", ref _Kind, value); }
        }
        #endregion

        #region Code
        private SLCode _Code;
        public SLCode Code
        {
            get { return _Code; }
        ...
        {
            get { return _Bare; }
            set { SetPropertyValue("Bare", ref _Bare, value); }
        }
        #endregion

        #region Prod Code Date
        private string _ProdCodeDate;
        public string ProdCodeDate
        {
            get { return _ProdCodeDate; }
            set { SetPropertyValue("ProdCodeDate", ref _ProdCodeDate, value); }
        }
        #endregion
        ...
        public string Component
        {
            ...
            set { SetPropertyValue<string>("Component", ref _Component, value); }
        }
        #endregion

        #region  TotalSurfaceArea
        private string _TotalSurfaceArea;
        [ImmediatePostData]
        public string TotalSurfaceArea
        {
            get { return _TotalSurfaceArea; }
            set { SetPropertyValue<string>("TotalSurfaceArea", ref _TotalSurfaceArea, value); }
        }
        #endregion
    }
}
