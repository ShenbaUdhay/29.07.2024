...
namespace ICM.Module.BusinessObjects
{
    ...
    public class Packageunits : BaseObject
    {
        #region Constructor
        public Packageunits(Session session) : base(session) { }
        #endregion
        ...
        // [RuleStringComparison("RuleStringComparison_PackageOption_NotNullOrEmpty", DefaultContexts.Save, StringComparisonType.NotEquals, null)]
        [RuleUniqueValue]
        [XafDisplayName("Name")]
        ...
        #region sort
        private int fSort;
        [RuleRequiredField("Sorts", DefaultContexts.Save, "'Name must not be empty'")]
        public int Sort
        {
            get { return fSort; }
