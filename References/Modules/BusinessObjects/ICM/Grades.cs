...
namespace ICM.Module.BusinessObjects
{
    ...
    [DefaultClassOptions]
    public class Grades : BaseObject
    {
        #region Constructor
        public Grades(Session session) : base(session) { }
        #endregion
        ...
        #region grade
        string fGrade;
        [RuleRequiredField("Grade", DefaultContexts.Save, "'Name must not be empty'")]
        // [RuleStringComparison("RuleStringComparison_Grade_NotNullOrEmpty", DefaultContexts.Save, StringComparisonType.NotEquals, null)]
        [RuleUniqueValue]
        [XafDisplayName("Name")]
        public string Grade
        {
            ...
            set
            {
                if (value == null)
                    value = string.Empty;
                SetPropertyValue<string>("Grade", ref fGrade, value.Trim());
            }
        }
        #endregion
