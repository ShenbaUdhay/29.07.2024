...
Public Module HorizontalReportDesignGenerator
    ...
    Public strDataSourceQuery As String = String.Empty
    ...
    Public Function GenerateRowsasColumn(ByVal rep As XtraReport) As XtraReport
        ...
        If Not dtTable Is Nothing AndAlso dtTable.Rows.Count > 0 Then
            ...
            Dim strSplitRowColumn() As String = Split(strRowColumn, ", ")
            Dim strRow As New System.Collections.Generic.List(Of String)
            For i As Integer = 0 To strSplitRowColumn.Length - 1
                strRow.Add(strSplitRowColumn(i))
            Next

            Dim strSplitNormalColumn() As String = Split(strNormalColumn, ", ")
            Dim strNormal As New System.Collections.Generic.List(Of String)
            For ii As Integer = 0 To strSplitNormalColumn.Length - 1
                strNormal.Add(strSplitNormalColumn(ii))
            Next

            Dim dtParameterDetails As DataTable = dtTable.DefaultView.ToTable(True, strRow.ToArray())
            Dim dtSampleDetails As DataTable = dtTable.DefaultView.ToTable(True, strNormal.ToArray())
